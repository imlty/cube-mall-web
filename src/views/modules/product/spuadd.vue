        ...
        <el-card class="box-card" style="width:80%;margin:20px auto">
          <el-form ref="spuBaseForm" :model="spu" label-width="120px" :rules="spuBaseInfoRules">
            ...
            <el-form-item label="商品介绍" prop="decript">
                  <el-input type="textarea"  v-model="spu.decript"></el-input>
            </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      spuBaseInfoRules: {
        ...
        decript: [
          { required: true, message: "请上传商品", trigger: "blur" }
        ],
    ...
    generateSkus() {
      ...
      descartes.forEach((descar, descaridx) => {
        ...
        descar.forEach((de, index) => {
          ...
          console.log("saleAttrItem:"+saleAttrItem)
  ...
  mounted() {
    ...
    this.catPathSub = PubSub.subscribe("categoryPath", (msg, val) => {
